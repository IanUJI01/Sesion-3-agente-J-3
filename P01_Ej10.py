...
r_1 = int(input('Introduce el radio del primer circulo: '))
...
r_2 = int(input('Introduce el radio del segundo circulo: '))
...
if turt.distance(centroX_1,centroX_2)<=r_1 and turt.distance(centroY_1,centroY_2)<=r_2:
    turt.color("purple")
    print('morado')
else:
    if turt.distance(centroX_1,centroX_2)<=r_1 and turt.distance(centroY_1,centroY_2)>r_2:
